  ...
  [ChainId.CRONOSMAINNET]: [
...

    {
      ...
      tokens: [new Token(
        ...
        "IcyCRO",
        "IcyCRO"
      ), new Token(ChainId.CRONOSMAINNET, '0xD5508C61381f4905e2b2d3694a982936F43650fE', 18, '', '')],
    ...
    },
    {
      ...
      extraMessage: 'Please remove your Photons from this pool and move it to new pool.',
      tokens: [UNI[ChainId.CRONOSMAINNET], new Token(ChainId.CRONOSMAINNET, '0xD5508C61381f4905e2b2d3694a982936F43650fE', 18, '', '')],
      stakingRewardAddress: '0x182E53dCe1FD5701E3fe149C5DB486C7e021548B',
      rewardTokenAddress: UNI[ChainId.CRONOSMAINNET].address,
      rewardTokenName: UNI[ChainId.CRONOSMAINNET].symbol??'PHOTON',
      rewardTokenSymbol: UNI[ChainId.CRONOSMAINNET].symbol??'PHOTON',
      rewardTokenDecimals: 18,
...

    {
      ...
      tokens: [UNI[ChainId.CRONOSMAINNET], new Token(ChainId.CRONOSMAINNET, '0xD5508C61381f4905e2b2d3694a982936F43650fE', 18, '', '')],
      stakingRewardAddress: '0xFea7651747DA75F99d6Dba77D5eE66E20dBc3be0',
      rewardTokenAddress: UNI[ChainId.CRONOSMAINNET].address,
      rewardTokenName: UNI[ChainId.CRONOSMAINNET].symbol??'PHOTON',
      rewardTokenSymbol: UNI[ChainId.CRONOSMAINNET].symbol??'PHOTON',
      rewardTokenDecimals: 18,
    },
    {
      ...
      rewardEnded: false,
      extraMessage: 'Reward Starts: 2022-05-11 13:00:00 UTC',
      tokens: [new Token(ChainId.CRONOSMAINNET, '0x30078453DEaD93bdBC31b9A18AC0a6ece171F459', 9, 'UCRO', 'UtilityCRO'), new Token(ChainId.CRONOSMAINNET, '0xD5508C61381f4905e2b2d3694a982936F43650fE', 18, '', '')],
      stakingRewardAddress: '0x4e6750AC51ffDb150b4b45F2a0Ab28F04e756a42',
...

    {
      stakeId: 13,
      rewardEnded: true,
      extraMessage: 'Reward Starts: 2022-07-30 12:30:00 UTC',
      tokens: [UNI[ChainId.CRONOSMAINNET], new Token(ChainId.CRONOSMAINNET, '0xD5508C61381f4905e2b2d3694a982936F43650fE', 18, '', '')],
      stakingRewardAddress: '0x51A430D3Dea743E93f3be90fd7a71F1F52E8e20A',
      rewardTokenAddress: '0x30078453DEaD93bdBC31b9A18AC0a6ece171F459',
      rewardTokenName: 'UtilityCRO',
      rewardTokenSymbol: 'UCRO',
      rewardTokenDecimals: 9,
...

    {
      ...
      extraMessage: 'Reward Starts: 2022-07-30 12:30:00 UTC',
      tokens: [new Token(ChainId.CRONOSMAINNET, '0x30078453DEaD93bdBC31b9A18AC0a6ece171F459', 9, 'UCRO', 'UtilityCRO'), new Token(ChainId.CRONOSMAINNET, '0xD5508C61381f4905e2b2d3694a982936F43650fE', 18, '', '')],
      stakingRewardAddress: '0x2f8129056734e40a7a158718f07066C1f2CfCE03',
      rewardTokenAddress: UNI[ChainId.CRONOSMAINNET].address,
      rewardTokenName: UNI[ChainId.CRONOSMAINNET].symbol ?? 'PHOTON',
      rewardTokenSymbol: UNI[ChainId.CRONOSMAINNET].symbol ?? 'PHOTON',
      rewardTokenDecimals: 18,
  ...
  [ChainId.KAVA_MAINNET]:[
    {
      stakeId: 12,
      rewardEnded: false,
      extraMessage: 'Reward Starts: 2022-07-02 06:00:00 UTC',
      tokens: [UNI[ChainId.KAVA_MAINNET], new Token(ChainId.KAVA_MAINNET, '0x00E24C35c3da29dd08f952747037326abC45B500', 18, '', '')],
      stakingRewardAddress: '0x9f4A56950036d45C8Ead7E836acE693D15F151d1',
  ...
  const info = useMemo(
    () =>
      chainId
        ...
        : [],
    [chainId, pairToFilterBy, stakeId, tokenToFilterBy]
  )
  //console.log(info)
...
export function useTotalUniEarned(): TokenAmount | undefined {
  ...
  return useMemo(() => {
    ...
    return (
      stakingInfos?.filter(stakingInfo => stakingInfo.rewardToken.address.toLowerCase() === uni.address.toLowerCase()).reduce(
  ...
  return useMemo(() => {
    ...
    return rewardsAddresses.reduce<SyrupInfo[]>((memo, rewardsAddress, index) => {
      ...
      if (
        ...
        const stakedAmount = new TokenAmount(lp && lp !== '' ? new Token(safeChainId, lp, 18, "SLP", "Staked LP") : USDT[safeChainId], JSBI.BigInt(balanceState?.result?.[0] ?? 0))
        const totalStakedAmount = new TokenAmount(lp && lp !== '' ? new Token(safeChainId, lp, 18, "SLP", "Staked LP") : USDT[safeChainId], JSBI.BigInt(totalSupplyState.result?.[0]))
        ...
        memo.push({
          ...
          dQuickTotalSupply: new TokenAmount(USDT[safeChainId], JSBI.BigInt(_dQuickTotalSupply?.result?.[0] ?? 0)),
