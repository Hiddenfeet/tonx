...
import { DataCard, CardSection, Break } from '../Stake/styled'
...
import { CardNoise, CardBGImage, CardBGImageSmaller } from '../Stake/styled'
      ...
      {!attempting && (
        <ContentWrapper gap="lg">
          <ModalUpper>
            ...
            <CardSection gap="md">
              <RowBetween>
                <TYPE.white fontWeight={500}>Claim {mainToken.symbol} Token</TYPE.white>
          ...
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              Enter an address to trigger a {mainToken.symbol} claim. If the address has any claimable {mainToken.symbol} it will be sent to them on
              submission.
            </TYPE.subHeader>
