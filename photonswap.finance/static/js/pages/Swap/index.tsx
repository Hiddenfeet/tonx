import { CurrencyAmount, JSBI, Token, Trade } from "@photonswap/sdk";
import React, {
  useCallback,
  useContext,
  useEffect,
...
import { useActiveWeb3React, addTokenMetaMask } from "../../hooks";
...
export default function Swap() {
  ...
  function addTokenIntoMetaMask() {
    if (currencies[Field.INPUT] !== undefined) {
      var currency;
      ...
      const tokenAddress =
        currency instanceof Token ? currency.address : undefined;
      addTokenMetaMask(
        tokenAddress,
        currency?.name,
        currency?.getDisplaySymbol(chainId),
        currency?.decimals,
        ""
      );
    } else {
      console.log("Filed addTokenIntoMetaMask");
    }
  }
    ...
    <>
      ...
      >
        <div
          ...
          data-design="modern"
          data-coins="bitcoin,ethereum,matic,photonswap,crypto-com-coin"
