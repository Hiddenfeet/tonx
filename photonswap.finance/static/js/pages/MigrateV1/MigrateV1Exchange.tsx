...
import { ChainId, Currency, CurrencyAmount, Fraction, JSBI, Percent, Token, TokenAmount, WETH } from '@photonswap/sdk'
...
import { CHAIN_SYMBOL, DEFAULT_DEADLINE_FROM_NOW, INITIAL_ALLOWED_SLIPPAGE } from '../../constants'
...
export function V1LiquidityInfo({
  ...
  return (
    <>
      ...
      <RowBetween mb="1rem">
        <Text fontSize={16} fontWeight={500}>
          Pooled {CHAIN_SYMBOL[chainId === undefined ? ChainId.CRONOSTEST : chainId]}:
        </Text>
        <RowFixed>
          <Text fontSize={16} fontWeight={500} marginLeft={'6px'}>
        ...
        <YellowCard>
          ...
          <AutoColumn gap="8px">
            ...
            <RowBetween>
              ...
              <TYPE.main color="inherit">{priceDifferenceAbs?.toSignificant(4)}%</TYPE.main>
            </RowBetween>
          </AutoColumn>
        </YellowCard>
      ) : null}
  ...
  const liquidityToken: Token | undefined = useMemo(
    () =>
      validatedAddress && chainId && token
        ? new Token(chainId, validatedAddress, 18, `PHOTON-V1-${token.symbol}`, 'Uniswap V1')
        : undefined,
