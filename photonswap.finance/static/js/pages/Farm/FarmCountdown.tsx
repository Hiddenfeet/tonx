...
import { FARMING_GENESIS, REWARDS_DURATION_DAYS } from '../../state/farm/hooks'
...
export function FarmCountdown({ exactEnd }: { exactEnd?: Date }) {
  // get end/beginning times
  const end = useMemo(() => (exactEnd ? Math.floor(exactEnd.getTime() / 1000) : FARMING_GENESIS + REWARDS_DURATION), [
    exactEnd
  ])
