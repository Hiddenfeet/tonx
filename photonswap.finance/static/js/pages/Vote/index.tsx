...
import { JSBI, TokenAmount, ChainId } from '@photonswap/sdk'
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>{process.env.REACT_APP_NAME} Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  UNI tokens represent voting shares in Cr{process.env.REACT_APP_NAME}odex governance. You can vote on each proposal yourself or
              ...
              <ExternalLink
                ...
                target="_blank"
              >
                <TYPE.white fontSize={14}>Read more about {process.env.REACT_APP_NAME} governance</TYPE.white>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
          <CardBGImage />
          ...
          <RowBetween>
            ...
            {userDelegatee && userDelegatee !== ZERO_ADDRESS ? (
              <RowFixed>
                ...
                <AddressButton>
                  <StyledExternalLink
                    href={getEtherscanLink(ChainId.CRONOSTEST, userDelegatee, 'address')}
                    style={{ margin: '0 4px' }}
                  >
