...
import { CardSection, DataCard } from '../../components/Stake/styled'
...
import { TokenAmount, JSBI } from '@photonswap/sdk'
    ...
    <PageWrapper gap="lg" justify="center">
      ...
      <ProposalInfo gap="lg" justify="start">
        ...
        <AutoColumn gap="md">
          ...
          <MarkDownWrapper>
            <ReactMarkdown children={proposalData?.description == null ? "" : proposalData?.description} />
          </MarkDownWrapper>
        </AutoColumn>
        <AutoColumn gap="md">
          ...
          >
            <ReactMarkdown children={proposalData?.proposer == null ? "" : proposalData?.proposer} />
          </ExternalLink>
        </AutoColumn>
      </ProposalInfo>
    </PageWrapper>
